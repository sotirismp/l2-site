...
<?php
  if (isset($_REQUEST["newreg"]))
  {
    ...
    $registerQuery = 'INSERT INTO user (regfullname,regusername,regpassword) VALUES (:regfn,:reguser,:regpass)';


    $registerCAD = $db->prepare($registerQuery); 
    $registerCAD -> bindValue(':regfn',$rf,PDO::PARAM_STR);
    $registerCAD -> bindValue(':reguser',$ru,PDO::PARAM_STR);
    $registerCAD -> bindValue(':regpass',$rp,PDO::PARAM_STR);
    $registerCAD -> execute();
  }
